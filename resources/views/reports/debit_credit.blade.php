    ...
    <div class="row" style="margin-top: 2%;">
        <div class="col">
            <div class="bg-white rounded-lg py-5 px-5">
                <h2 id="tr" class="text-center">Transaction Report</h2>
        ...
        $(function() {
            ...
            function load_data(from_date = '', to_date = '', account_type_id = '')
            {
                $('#trips_report_table').DataTable({
                    ...
                    buttons: [
                        ...
                        {
                            extend: 'print',
                            messageTop: '<h2>Transaction Report ' + account_type + '</h2>',
                            footer: true
                        }
                    ],
                    ajax: {
                        url:'{!! route("get_debit_credit") !!}',
            ...
            $('#filter').click(function(){
                ...
                if (account_type != ''){
                    ...
                    document.getElementById("tr").innerHTML = 'Transaction Report'+account_type;
                }else {
                    account_type = '';
                    document.getElementById("tr").innerHTML = 'Transaction Report'+account_type;
                }
            ...
            $('#refresh').click(function(){
                ...
                $('#trips_report_table').DataTable().destroy();
                document.getElementById("tr").innerHTML = 'Transaction Report';
                load_data();
            });
