    ...
    <div class="row" style="margin-top: 2%;">
        <div class="col">
            <div class="bg-white rounded-lg py-5 px-5">
                <h2 id="tr" class="text-center">Sales Report</h2>
        ...
        $(function() {
            ...
            function load_data(from_date = '', to_date = '', customer_id = '')
            {
                $('#trips_report_table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'paid', name: 'paid', className: 'sum' },
            ...
            $('#filter').click(function(){
                ...
                if (customer_id != ''){
                    ...
                    document.getElementById("tr").innerHTML = 'Sales Report'+customer_name;
                }else {
                    customer_name = '';
                    document.getElementById("tr").innerHTML = 'Sales Report'+customer_name;
                }
