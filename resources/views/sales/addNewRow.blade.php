<tr>
    ...
    <td>
        {{Form::select('product_id[]', $products, null, ['class' => 'select2_op form-control pid', 'placeholder' => 'Pick a Product...', 'required']) }}
    ...
    <td>
        {{Form::number('discount[]', 0, ['class' => 'form-control form-control-sm pdis', 'placeholder' => 'Discount %', 'step' => '0.01','required' ]) }}
    </td>
    <td>
