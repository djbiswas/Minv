...
@section('content')
    <div class="row mt-minus">
        <div class="col">
            <div class="row">
                <div class="col">
                    <h5 class="page-heading text-light mb-4 mt-4 mt-md-0"><i class="material-icons">assignment</i>Order</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="margin-top: 2%;">
        <div class="col">
            <div class="bg-white rounded-lg py-5 px-5">
                <h2 class="text-white">New Invoice </h2>
                                ...
                                <div class="col-md-6 offset-md-2 col-lg-6 offset-lg-2 ">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                {{Form::number('discount', 0, ['id' => 'discount','class' => 'form-control form-control-sm', 'placeholder' => 'Discount %', 'required' ]) }}
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.pid', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        total = tr.find('.oqty').val() * tr.find('.price').val();
                        tdis = (total / 100) * tr.find('.pdis').val();

                        tr.find('.tprice').val(total - tdis);
                        invoice_calculate(0);
            ...
            $(document).on('keyup', '.pdis', function(event) {
                // var price = $(this);
                var tr = $(this).parent().parent();
                var total=0;
                var tdis = 0;
